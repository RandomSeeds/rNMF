...
**Regular NMF** decomposition (trim = FALSE, k = 4) gives the following result.
```{r, echo=TRUE}
...
Now the same data is decomposed with **rNMF** with trimming (trim = 0.03, k = 4)
```{r, echo=TRUE}
...
The results are more clear and the outliers are extracted almost perfectly:
